...
addObstacles :: [Point2d] -> Point2d -> Dir -> Room -> Int
addObstacles path pos dir room = length $ filter isNothing placeObs 
    where 
...
day06 = do
    ...
    print $ length path
    print $ addObstacles path start North room
